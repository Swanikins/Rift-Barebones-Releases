...
public:
	...
	bool is_x_down() const override { return is_mapping_down(kButtonId_1); }
	bool is_y_down() const override { return is_mapping_down(kButtonId_2); }
	bool is_l_down() const override { return is_mapping_down(kButtonId_Nunchuck_C); }
	bool is_r_down() const override { return is_mapping_down(kButtonId_Nunchuck_Z); }
	bool is_home_down() const override { return is_mapping_down(kButtonId_Home); }
	bool is_quick_menu_down() const override { return is_mapping_down(kButtonId_Nunchuck_Z) && is_mapping_down(kButtonId_Down); }
