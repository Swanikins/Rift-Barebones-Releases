...
public:
	...
	void start_rumble();
	void stop_rumble();
	static uint32 ConsumeMenuToggleRequests(size_t& playerIndex);
	static void SetRiftInputCaptured(bool captured);
	static bool IsRiftInputCaptured();
	...
	virtual bool is_x_down() const = 0;
	virtual bool is_y_down() const = 0;
	virtual bool is_l_down() const = 0;
	virtual bool is_r_down() const = 0;
	virtual bool is_home_down() const = 0;
	virtual bool is_quick_menu_down() const = 0;
...
protected:
	...
	std::atomic_bool m_quickMenuChordDown{false};
	static std::atomic_uint32_t s_menuToggleRequests;
	static std::atomic_size_t s_menuToggleOwner;
	static std::atomic_bool s_riftInputCaptured;
};
