...
public:
	...
	bool is_x_down() const override { return is_mapping_down(kButtonId_X); }
	bool is_y_down() const override { return is_mapping_down(kButtonId_Y); }
	...
	bool is_quick_menu_down() const override { return is_mapping_down(kButtonId_R) && is_mapping_down(kButtonId_Down); }
