...
public:
	...
	int get_index(size_t guid_index, const SDL_JoystickGUID& guid, std::string_view display_name,
		SDL_JoystickGUID* resolved_guid = nullptr, size_t* resolved_guid_index = nullptr) const;
