...
static LatteOverlayRenderCallback s_skylanderQuickMenuCallback = nullptr;

void LatteOverlay_setSkylanderQuickMenuCallback(LatteOverlayRenderCallback callback)
{
	s_skylanderQuickMenuCallback = callback;
}
...
void LatteOverlay_render(bool pad_view)
{
	...
	if (s_skylanderQuickMenuCallback)
		s_skylanderQuickMenuCallback(pad_view);
