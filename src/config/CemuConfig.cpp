...
void CemuConfig::Load(XMLConfigParser& parser)
{
	...
	emulated_usb_devices.skylander_hub_card_size = std::clamp(usbdevices.get<sint32>("SkylanderHubCardSize", 100), 75, 115);
	emulated_usb_devices.skylander_hub_layout = std::clamp(usbdevices.get<sint32>("SkylanderHubLayout", emulated_usb_devices.skylander_hub_layout), 0, 2);
	emulated_usb_devices.skylander_hub_ornament = std::clamp(usbdevices.get<sint32>("SkylanderHubOrnament", emulated_usb_devices.skylander_hub_ornament), 0, 2);
	emulated_usb_devices.skylander_cascade_style = std::clamp(usbdevices.get<sint32>("SkylanderCascadeStyle", emulated_usb_devices.skylander_cascade_style), 0, 3);
	...
	emulated_usb_devices.skylander_element_filter = std::clamp(usbdevices.get<sint32>("SkylanderElementFilter", emulated_usb_devices.skylander_element_filter), 0, 11);
...
void CemuConfig::Save(XMLConfigParser& parser)
{
	...
	usbdevices.set("SkylanderPortalMode", emulated_usb_devices.skylander_portal_mode.GetValue());
	usbdevices.set("SkylanderHybridModeEnabled", emulated_usb_devices.skylander_hybrid_mode_enabled.GetValue());
	usbdevices.set("SkylanderCollectionPath", emulated_usb_devices.skylander_collection_path.GetValue());
	usbdevices.set("SkylanderSortMode", emulated_usb_devices.skylander_sort_mode.GetValue());
	usbdevices.set("SkylanderFavorites", emulated_usb_devices.skylander_favorites.GetValue());
	usbdevices.set("SkylanderMotionLevel", emulated_usb_devices.skylander_motion_level.GetValue());
	usbdevices.set("SkylanderBloomLevel", emulated_usb_devices.skylander_bloom_level.GetValue());
	usbdevices.set("SkylanderUiSound", emulated_usb_devices.skylander_ui_sound.GetValue());
	usbdevices.set("SkylanderUiHaptics", emulated_usb_devices.skylander_ui_haptics.GetValue());
	usbdevices.set("SkylanderUiPreset", emulated_usb_devices.skylander_ui_preset.GetValue());
	usbdevices.set("SkylanderSoundProfile", emulated_usb_devices.skylander_sound_profile.GetValue());
	...
	usbdevices.set("SkylanderHubPalette", emulated_usb_devices.skylander_hub_palette.GetValue());
	usbdevices.set("SkylanderHubSpacing", emulated_usb_devices.skylander_hub_spacing.GetValue());
	usbdevices.set("SkylanderHubCardSize", emulated_usb_devices.skylander_hub_card_size.GetValue());
	usbdevices.set("SkylanderHubLayout", emulated_usb_devices.skylander_hub_layout.GetValue());
	usbdevices.set("SkylanderHubOrnament", emulated_usb_devices.skylander_hub_ornament.GetValue());
	usbdevices.set("SkylanderCascadeStyle", emulated_usb_devices.skylander_cascade_style.GetValue());
	usbdevices.set("SkylanderParticleLevel", emulated_usb_devices.skylander_particle_level.GetValue());
	...
	usbdevices.set("SkylanderElementFilter", emulated_usb_devices.skylander_element_filter.GetValue());
