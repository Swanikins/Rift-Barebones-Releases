...
#undef DISABLE_SCREENSAVER_DEFAULT
	...
	struct
	{
		...
		ConfigValue<sint32> skylander_motion_level{2};
		ConfigValue<sint32> skylander_bloom_level{1};
		ConfigValue<bool> skylander_ui_sound{true};
		ConfigValue<bool> skylander_ui_haptics{true};
		ConfigValue<sint32> skylander_ui_preset{1};
		ConfigValue<sint32> skylander_sound_profile{1};
        ...
        ConfigValue<sint32> skylander_hub_spacing{100};
        ConfigValue<sint32> skylander_hub_card_size{100};
		ConfigValue<sint32> skylander_particle_level{1};
		...
		ConfigValue<sint32> skylander_element_filter{0};
