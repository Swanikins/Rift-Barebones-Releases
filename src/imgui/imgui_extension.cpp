...
static std::atomic_bool s_gamepadNavigationEnabled{true};

void ImGui_SetGamepadNavigationEnabled(bool enabled)
{
	s_gamepadNavigationEnabled = enabled;
}
...
void ImGui_UpdateWindowInformation(bool mainWindow)
{
	...
	for (auto i = 0; s_gamepadNavigationEnabled && i < InputManager::kMaxController; ++i)
	{
